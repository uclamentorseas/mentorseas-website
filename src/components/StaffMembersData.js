...
const staffMembers = {
  executive: [
    ...
    },
    {
      ...
      restaurant: 'Gushi',
      description:
        "Hey there! I'm a 3rd year Mechanical Engineering major. I like to do yoga, try new foods, and watch lots of YouTube. I was also a New Student Advisor in the summer, and I'm stoked to be meet you fellow Bruins!",
      links: {
  ...
  staffMember: [
    ...
    },
    {
      ...
      description:
        'I am a C&EE Senior. I also am the Mentorship Chair for the ASCE at UCLA Student Chapter. I love ALL sports, skateboarding, sneakers, Smash Bros, Supreme, Pokemon, anything else Nintendo, and, of course, anything UCLA.',
      links: {
    ...
    },
    {
      ...
      description:
        "A nomadic 3rd year Computer Science major indigenous to Northern California whose current obsessions include web development, playing guitar, and pondering his life's purpose. A fickle creature, he is subject to change this bio by the next time you see it.",
      links: {
    ...
    },
    {
      ...
      restaurant: "Ike's",
      description:
        "Hey all! My name is Akhil Harapanahalli, and I'm a junior Bioengineering major. My academic and career interests are in research, where I love to study biomarker discovery. Some of my other passions are playing basketball and volunteering for Special Olympics. Looking forward to working with you!",
      links: {
    ...
    },
    {
      ...
      restaurant: 'Gushi',
      description:
        'I am a CS student from the Bay Area (Los Altos), who is trying to figure it out. Constantly thinking about the intersection of things and existential questions. Please feel free to reach out!',
      links: {
    ...
    },
    {
      ...
      description:
        "I'm a second year majoring in aerospace engineering and it's my first time on the MentorSEAS board. I've participated in other organizations on campus and I'm excited to apply my leadership skills. In my free time, I like to play soccer and guitar, listen to music, read and workout.",
      links: {
    ...
    },
    {
      ...
      restaurant: 'CAVA',
      description:
        'Hi! I am a Junior at UCLA studying BioEngineering. I am currently the Internal Vice President of the Engineering society at UCLA and the Recruitment Director of Sigma Eta Pi. I am super excited to work with all the Mentors and Mentees at MentorSEAS.',
      links: {
    ...
    },
    {
      ...
      restaurant: 'Gushi',
      description:
        'I am a third-year Mechanical Engineer. I aim to be versatile and adaptable in order to do my best and provide an impact wherever I go. I am always curious and try to dedicate at least one hour everyday to learn variety of subjects.',
      links: {
