      ...
      <div className="page-contents">
        ...
        <TextWrapper>
          ...
          <StepsWrapper>
            <Text size={18}>
              {'1. Log on to '}
              <a target="_blank" rel="noopener noreferrer" href="https://my.engineering.ucla.edu">
                my.engineering.ucla.edu
              </a>
              {' and click on "About Me" under "My Profile".'}
            </Text>
            <TutorialImage alt="1" src={myEngImage} />
            <Text size={18}>
              {
          ...
          <Text size={18}>
            {"** If the mentor signup on myEngineering doesn't work for you, please sign up "}
            <a target="_blank" rel="noopener noreferrer" href="http://bit.ly/mentorseasalternatesignup">
              here
            </a>
            {'.'}
          </Text>
